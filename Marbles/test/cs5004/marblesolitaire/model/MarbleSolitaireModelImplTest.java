...
public class MarbleSolitaireModelImplTest {
  ...
  /**
   * Tests whether constructor can take in R and C and make a board with a specified _.
   * and use default AR.
   */
  @Test
  ...
  /**
   * testMovesNotSameRowNorColumn. On a board of arm length 3 and default empty cell, should not
   * be able to move from (1,2) to (3,3). Illegal Argument should be thrown.
   */
